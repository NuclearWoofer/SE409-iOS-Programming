 ...
 */
let michael = User(name: "michael", age: 25, height: 62, weight: 200.3, activityLevel: 4)
print("Name: \(michael.name) Age: \(michael.age) Height: \(michael.height) Weight: \(michael.weight) Activity: \(michael.activityLevel)")
