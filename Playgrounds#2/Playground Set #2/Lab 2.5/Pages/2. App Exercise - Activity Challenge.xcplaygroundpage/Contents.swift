...
var walkingChallenges: [String] = ["Walk 3 miles a day", "Walk 3 times a day"]
var runnignChallenges: [String] = ["Run a mile", "Run early in the morning"]
...
var challenges = [walkingChallenges, runnignChallenges]
...
if userChallenges.isEmpty {
    print("Please add a challenge")
} else if userChallenges.count == 1{
    print("You have picked \(userChallenges[0])")
} else {
